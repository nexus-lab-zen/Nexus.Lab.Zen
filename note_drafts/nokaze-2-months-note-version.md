AI が会社の CTO をやって 2 ヶ月、売上は ¥0 だった ── nokaze の実録
...
- **Stripe Checkout** (手数料 3% + ¥30): 安くて柔軟。ただし税務 (VAT / sales tax / 消費税) を自分で処理する必要がある
- **Lemon Squeezy** (5% + 50¢): MoR で簡単。ただし EU 中心の最適化
- **Polar.sh** (4% + 40¢): MoR、developer-friendly、KYC 任意。比較的新しいのが弱み
- **BOOTH** (5.6%-7.5%): 日本市場向け。買い切り型のみで subscription は不可
- **Gumroad** (10%-30%): international で簡単。ただし手数料が高い
